...
// Complete mock Data grouped by College and Course for the Main Campus
const mockDataByCollege = [
  {
    collegeId: "cics",
    collegeName: "College of Information and Computing Sciences",
    shortName: "CICS",
    courses: [
      {
        courseName: "BS Information Technology",
        applicants: [
          { id: "APP-2026-0842", name: "Dela Cruz, Juan M.", status: "Pending Review", date: "Jul 28, 2026" },
          { id: "APP-2026-0835", name: "Mendoza, Paul R.", status: "Flagged", date: "Jul 26, 2026" }
        ]
      },
      {
        courseName: "BS Information Systems",
        applicants: [
          { id: "APP-2026-0810", name: "Garcia, Elena B.", status: "Approved", date: "Jul 25, 2026" },
          { id: "APP-2026-0792", name: "Alvarez, Marco S.", status: "Pending Review", date: "Jul 23, 2026" }
        ]
      }
    ]
  },
    ...
    courses: [
      {
        ...
        applicants: [
          { id: "APP-2026-0843", name: "Reyes, Maria C.", status: "Pending Review", date: "Jul 28, 2026" }
        ]
      },
      {
        courseName: "BS Industrial Technology",
        applicants: [
          { id: "APP-2026-0790", name: "Santos, Mark J.", status: "Pending Review", date: "Jul 24, 2026" },
          { id: "APP-2026-0788", name: "Bautista, Luis T.", status: "Approved", date: "Jul 23, 2026" }
        ]
      }
    ]
  },
    ...
    courses: [
      {
        ...
        applicants: [
          { id: "APP-2026-0750", name: "Fernandez, Ana L.", status: "Pending Review", date: "Jul 20, 2026" },
          { id: "APP-2026-0731", name: "Cruz, Patricia D.", status: "Rejected", date: "Jul 18, 2026" }
        ]
      },
      {
        courseName: "Bachelor of Elementary Education",
        applicants: [
          { id: "APP-2026-0710", name: "Diaz, Roberto K.", status: "Approved", date: "Jul 15, 2026" }
        ]
      }
    ]
  },
  {
    collegeId: "cpes",
    collegeName: "College of Physical Education and Sports",
    shortName: "CPES",
    courses: [
      {
        courseName: "BS Exercise and Sports Sciences",
        applicants: [
          { id: "APP-2026-0680", name: "Luna, Miguel A.", status: "Pending Review", date: "Jul 10, 2026" }
        ]
      }
    ]
  },
  {
    ...
    courses: [
      {
        courseName: "BS Marine Engineering",
        applicants: [
          { id: "APP-2026-0665", name: "Villanueva, John P.", status: "Flagged", date: "Jul 08, 2026" }
        ]
      }
    ]
  },
  {
    collegeId: "cahss",
    collegeName: "College of Arts, Humanities, and Social Sciences",
    shortName: "CAHSS",
    courses: [
      {
        courseName: "BS Development Communication",
        applicants: [
          { id: "APP-2026-0640", name: "Ramos, Chloe B.", status: "Approved", date: "Jul 05, 2026" }
        ]
      },
      {
        courseName: "Batsilyer ng Sining sa Filipino",
        applicants: []
      }
    ]
  },
  {
    collegeId: "sba",
    collegeName: "School of Business Administration",
    shortName: "SBA",
    courses: [
      {
        courseName: "BS Entrepreneurship",
        applicants: [
          { id: "APP-2026-0622", name: "Tan, Kelvin J.", status: "Pending Review", date: "Jul 02, 2026" }
        ]
      },
      {
        courseName: "BS Hospitality Management",
        applicants: [
          { id: "APP-2026-0610", name: "Ocampo, Lisa R.", status: "Pending Review", date: "Jul 01, 2026" },
          { id: "APP-2026-0599", name: "Gomez, Ryan T.", status: "Approved", date: "Jun 28, 2026" }
        ]
      }
    ]
  },
  {
    collegeId: "pnp",
    collegeName: "Pre-Baccalaureate / Non-Degree Programs",
    shortName: "PNP",
    courses: [
      {
        courseName: "2-Year Associate in Industrial Technology",
        applicants: [
          { id: "APP-2026-0550", name: "Navarro, Joel E.", status: "Pending Review", date: "Jun 20, 2026" }
        ]
      }
    ]
  }
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <Badge variant="secondary" className="bg-primary/5 text-primary border-primary/20 font-mono text-sm px-2.5 py-0.5 shadow-sm">
                  {id === 'pwd' ? 14 : id === 'ip' ? 22 : 8} Applicants
                </Badge>
              </div>
                                  ...
                                  <Table>
                                    <TableHeader className="bg-muted/30 border-b border-border/50">
                                      <TableRow className="hover:bg-transparent border-none">
                                        ...
                                        <TableHead className="text-right pr-6 font-medium text-muted-foreground">Action</TableHead>
                                      </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                      {course.applicants.map((app) => (
                                        <TableRow key={app.id} className="group border-b border-border/40 last:border-0 hover:bg-muted/20 transition-colors">
                                          ...
                                          <TableCell className="text-right pr-6">
                                            <Button variant="outline" size="sm" asChild className="text-primary border-primary/20 hover:text-primary hover:bg-primary/10 hover:border-primary/40 transition-all shadow-sm">
