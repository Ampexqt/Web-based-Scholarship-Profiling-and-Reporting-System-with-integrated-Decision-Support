...
import { LayoutDashboard, FileText, LogOut, CheckCircle } from "lucide-react"
              ...
              <SidebarMenuItem>
                <SidebarMenuButton size="lg" render={<Link to="/staff" />}>
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight group-data-[collapsible=icon]:hidden">
                    <span className="truncate font-semibold">ZPPSU Staff</span>
            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu className="gap-1">
                  <SidebarMenuItem>
                    <SidebarMenuButton size="lg" render={<Link to="/staff" />} isActive={location.pathname === '/staff'} tooltip="Overview">
                      <LayoutDashboard />
                      <span className="text-sm group-data-[collapsible=icon]:hidden">Overview</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton size="lg" render={<Link to="/staff/applications" />} isActive={location.pathname.startsWith('/staff/applications')} tooltip="Applications">
                      <FileText />
                      <span className="text-sm group-data-[collapsible=icon]:hidden">Applications</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton size="lg" render={<Link to="/staff/decision-support" />} isActive={location.pathname.startsWith('/staff/decision-support')} tooltip="Decision Support">
                      <CheckCircle />
                    ...
                    <div className="flex flex-col items-center text-center space-y-5">
                      ...
                      <div className="space-y-2">
                        ...
                        <AlertDialogDescription className="text-base text-muted-foreground">
                          Are you sure you want to log out? You will need to enter your credentials to access the portal again.
                        </AlertDialogDescription>
                      </div>
                    </div>
